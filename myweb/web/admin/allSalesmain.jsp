...
<head>
    ...
    <script>
        ...
        function checkvip() {
            if (formVip1.searchVip.value == null || formVip1.searchVip.value == "") {
                console.log("111");
                alert("所输入的vip号码为空！");
                formVip1.searchVip.focus();
                return false;
            }
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="SalesUseridServlet" name="salesuseridForm" id="salesuseridForm">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label class="col-md-3">销售店铺</label>
                                            <input class="col-md-5" type="text" name="salesUserid" id="salesUserid"
                                                   placeholder="四个数字"
                                            >
                                            <input type="submit" class="btn btn-outline-success btn-sm "
                                                   onclick="return checkSalesUserid();" value="确定"/>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="col-md-6">流水单号</label>
                                            <label><%=FutureFlowid%>
                                            </label>
                                        </div>
                                    </div>
                                    <%--<label style="width: 80px;">销售店铺</label>--%>
                                    <%--<input type="text" name="salesUserid" style="border-top-right-radius: 5px;border-top-left-radius: 5px;--%>
                                    <%--border-bottom-right-radius:5px;--%>
                                    <%--border-bottom-left-radius:5px;" id="salesUserid" placeholder="四个数字">--%>
                                    <%--<input type="submit" class="btn btn-outline-success btn-sm"--%>
                                    <%--onclick="return checkSalesUserid();" value="确定">--%>
                                ...
                                <%--&lt;%&ndash;<form accept-charset="GB18030" id="formVip1" name="formVip1"&ndash;%&gt;--%>
                                <%--&lt;%&ndash;action="../allCanAccept/searchVipByPhoneServlet" method="get">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<label>vip：</label>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<input type="text" style="border-top-right-radius: 5px;border-top-left-radius: 5px;&ndash;%&gt;--%>
                                <%--&lt;%&ndash;border-bottom-right-radius:5px;&ndash;%&gt;--%>
                                <%--&lt;%&ndash;border-bottom-left-radius:5px;" id="searchVip" name="searchVip"&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<% if(vipPhone != null && vipPhone !="") { %>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;value="<%=vipPhone%>"&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<%}%>>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<input type="submit" onclick="return checkvip();"&ndash;%&gt;--%>
                                <%--&lt;%&ndash;class="btn btn-gradient-success btn-sm" value="确定"/>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;</form>&ndash;%&gt;--%>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        %>
                                        <form accept-charset="GB18030" id="formVip1" name="formVip1"
                                              action="../allCanAccept/searchVipByPhoneServlet" method="get">
                                            <label class="col-md-3">vip</label>
                                            <input class="col-md-6" type="text" style="border-top-right-radius: 5px;border-top-left-radius: 5px;
                                                border-bottom-right-radius:5px;
                                                border-bottom-left-radius:5px;" id="searchVip" name="searchVip"
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <form name="staffInsertForm" action="../allCanAccept/insertAllSalesServlet">
                                            <label class="col-md-3">员工编号</label>
                                    ...
                                    <div class="col-md-3" >
                                        <button type="button" class="btn btn-gradient-dark btn-fw" onclick="one()">
                                            提交订单
                                        </button>
                                    </div>
                                </div>
                                ...
                                <table class="table table-bordered" border="5">
                                    ...
                                    <tr class="table-info">
                                        ...
                                        <td><input type="hidden"
                                                   ...
                                                   id="sumprice"/><fmt:formatNumber value="<%=sumprice%>" groupingUsed="false" type="number"
