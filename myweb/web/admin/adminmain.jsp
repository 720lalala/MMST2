                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form-inline" accept-charset="GB18030" name="formS"
                                      action="searchUserServlet" method="post">
                                    <div class="form-group col-4">
                                        <div class="input-group">
                                            <input type="text" id="SearchTemp" name="SearchTemp" class="form-control"
                                                   placeholder="用户编号或用户名" aria-label="Recipient's username"
                                    ...
                                    <div class="form-group col-4">
                                        <button type="button" class="btn btn-outline-primary btn-md"
                                                onclick="window.location.href='AllUserServlet'">全部寻找
                                        </button>
                                    </div>
                                    <div class="form-group col-4">
                                ...
                                <table class="table table-bordered" border="5" style="text-align:center">
                                    <tr class="table-info">
                                        <td>编号</td>
                                        <td>名称</td>
                                        <td>密码</td>
                                    ...
                                    <tr class="table-danger">
                                        ...
                                        <td style="width: 204px;">
                                            <input type="button" class="btn btn-outline-primary btn-sm"
                                                   onclick='one("<%=u.getUserid()%>","<%=u.getUsername()%>","<%=u.getPassword()%>") '
                                                   value="修改">
                                            <a href="javascript:void(0)"></a>
                                            </input>
                                            <label style="width: 10px;"></label>
                                            <button class="btn btn-outline-dark  btn-sm"
                                                    onclick="three('<%=u.getUserid()%>')">
                                                删除
                                            </button>
                                        </td>
                                    </tr>
                            ...
                            <form name="formD" action="deleteUserServlet" method="post">
