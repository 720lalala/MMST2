                        ...
                        <div class="card">
                            <div class="card-body">
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios"
                                                           ...
                                                           onclick="window.location.href='achievementUserServlet?value=0'">
                                                    今日
                                                </label>
                                            </div>
                                        </td>
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios"
                                                           ...
                                                           onclick="window.location.href='achievementUserServlet?value=1'">
                                                    今月
                                                </label>
                                            </div>
                                        </td>
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios"
                                                           ...
                                                           onclick="window.location.href='achievementUserServlet?value=2'">
                                                    今年
                                                </label>
                                            </div>
                                        </td>
                                ...
                                <table class="table table-bordered"style="text-align: center"   border="5">
                                    ...
                                    <%
                                        if (session.getAttribute("achievementUser") != null) {

                                            Vector<achievementUserDTO> v = (Vector<achievementUserDTO>) session.getAttribute("achievementUser");
                    ...
                    <div class="col-lg-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios1"
                                                           ...
                                                           onclick="window.location.href='achievementUserPaywayServlet?value=0'">
                                                    今日
                                                </label>
                                            </div>
                                        </td>
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios1"
                                                           ...
                                                           onclick="window.location.href='achievementUserPaywayServlet?value=1'">
                                                    今月
                                                </label>
                                            </div>
                                        </td>
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios1"
                                                           ...
                                                           onclick="window.location.href='achievementUserPaywayServlet?value=2'">
                                                    今年
                                                </label>
                                            </div>
                                        </td>
                                ...
                                <table style="text-align: center" class="table table-bordered" border="5">
                                    <tr class="table-info">
                                        <td>支付方式</td>
                                        <td>金额</td>
                                    </tr>
                                ...
                                <table style="text-align: center" class="table table-dark">
                                    ...
                                    <%
                                        if (session.getAttribute("salesKing") != null) {
                                            ...
                                            salesKingDTO u = (salesKingDTO) session.getAttribute("salesKing");
                                    %>
                                    <tr>
                                        <td><%=u.getClothingid()%>
                                        </td>
