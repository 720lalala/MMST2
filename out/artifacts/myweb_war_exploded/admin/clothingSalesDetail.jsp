            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <form name="date" action="searchclothingSalesServlet" accept-charset="GB18030"
                                      method="post">
                                    <div class="row">
                                    ...
                                    <div style="text-align: center">
                                        <button type="submit" class="btn btn-gradient-primary btn-rounded btn-fw">确定
                                        </button>
                                    </div>
                                ...
                                <table class="table table-dark" style="text-align: center" border="5">
                                    ...
                                    <%
                                        ...
                                        if (session.getAttribute("authority") != null) {
                                            ...
                                            Vector<DepotDTO> v = (Vector<DepotDTO>) session.getAttribute("sumSales");
